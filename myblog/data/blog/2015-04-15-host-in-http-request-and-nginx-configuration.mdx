...
summary: 以前配合后台开发app的时候，需要配host然后才能访问某些网页，比如dev.sunke.me，test.sunke.me，只知道这么做，却不知道为什么，今天研究了下，记录一下
---
...
![nginx configration picture](/static/images/nginx-configration.png)
...
![webpage via host for lisi](/static/images/webpage-via-host-for-lisi.png)  
![webpage via host for zhangsan](/static/images/webpage-via-host-for-zhangsan.png)

### 请求里面的host信息

![host information http request](/static/images/host-information-http-request.png)
