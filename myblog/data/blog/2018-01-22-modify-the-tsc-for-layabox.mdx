...
summary: 从[官网](https://www.layabox.com/)下载安装LayaAirIDE之后，新建一个项目，编译，会提示“版本不匹配! 全局 tsc (2.6.2) != VS Code 的语言服务(2.1.5)。可能出现不一致的编译错误”。最开始的时候我不太熟悉，就直接点击了“不要再次检查”。
---
...
![LayaBox TSC 版本不一致](/static/images/layaBoxTscVersionWarning.png)
...
![libs文件夹结构](/static/images/libsDirectoryAfterNpmInstallTypeScript.png)
...
![settings.json 内容](/static/images/layaBoxSettings.json.png)
