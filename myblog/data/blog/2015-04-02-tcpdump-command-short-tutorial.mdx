...
summary: 昨天在配合其他同事联调加解密的时候老大告诉我可以用tcpdump命令来简单的看下发来的请求是否是加密的，第一次听说这个命名，研究下
---
...
![ifconfig来获取网络接口](/static/images/ifconfig.png)
...
![tcpdump结果](/static/images/tcpdump.png)
