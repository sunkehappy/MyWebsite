...
summary: 由于家里的网络有问题，即使是用我的VPS上面的VPN也无法用Homebrew来安装node，最后不得不ssh到VPS上来下载，然后在本地用scp命令拉下来。
---
...
![unable to download node using brew](/static/images/unable-to-download-node-using-brew.png)
