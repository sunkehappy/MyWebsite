...
tags: [性能优化, React]
summary: 即便我们不去做性能优化，`React`内部已经帮我们做了很多性能上的优化，而`React.memo`可以更进一步优化组件的渲染次数。在这篇文章中我将会跟你解释一下如何通过使用`React.memo`来优化React性能，一些使用时候的常见错误，以及为什么你并不总是需要用`React.memo`
---
