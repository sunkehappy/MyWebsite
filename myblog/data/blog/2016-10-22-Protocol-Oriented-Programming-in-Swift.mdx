...
category: 翻译
tags: [WWDC, Swift, 翻译]
summary: 翻译自：[Protocol-Oriented Programming in Swift](https://www.infoq.com/news/2015/06/protocol-oriented-swift/)
---
...
![使用Self和不用的对比](/static/images/protocol-oriented-swift-1.jpeg)
