...
title: 优化WebPack打包结果
tags: [WebPack]
summary: 最近一直在做性能优化，最近在做的点就是打包体积优化，这里记录一下我的优化方法和结果。首先也要明白一些常见的减小包体积的措施，像[Tree Shaking](https://webpack.js.org/guides/tree-shaking/#root)，[Code Splitting](https://webpack.js.org/guides/code-splitting/#root)，[loadable-components](https://github.com/gregberge/loadable-components)，这些都可以用来减小[首页]包体积。
---
...
![on-boarding-before-optimization](/static/images/webpack-optimization/on-boarding-before-optimization.png)
...
![webpack-bundle-analyzer-sample](/static/images/webpack-optimization/webpack-bundle-analyzer-sample.gif)
...
![moment.js-language-data.jpg](/static/images/webpack-optimization/moment.js-language-data.jpg)
...
先看图：
![lodash-package-too-big](/static/images/webpack-optimization/lodash-package-too-big.png)
...
![on-boarding-after-optimization](/static/images/webpack-optimization/on-boarding-after-optimization.png)
