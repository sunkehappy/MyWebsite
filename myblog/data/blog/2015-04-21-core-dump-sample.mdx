...
title: core dump分析实例
tags: [Linux]
summary: 程序运行中间，如果出错了，有可能会有core dump，生成core.12345文件，这个文件有助于定位问题，这里记录下。
---
...
![设置core dump文件大小](/static/images/set-core-dump-file-size.png)
...
![生成core dump文件的程序](/static/images/source-to-generate-core-dump.png)
...
![用gdb查看core dump文件](/static/images/open-core-dump-file-with-gdb.png)
