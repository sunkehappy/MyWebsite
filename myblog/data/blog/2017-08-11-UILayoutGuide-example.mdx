...
tags: [Swift]
summary: 在iOS 9中引入了一个新的类[UILayoutGuide](https://developer.apple.com/documentation/uikit/uilayoutguide)。这个类可以用来
---
...
![UILayoutGuide的图示](/static/images/UILayoutGuideExample.png)
