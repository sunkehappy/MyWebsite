...
tags: [vite, 源代码]
summary: 这个`serverPluginModuleRewrite`文件是vite 1.0里面非常重要的一个文件，我们需要仔细分析一下，整体结构如下：
---

这个`serverPluginModuleRewrite`文件是vite 1.0里面非常重要的一个文件，我们需要仔细分析一下，整体结构如下：
![serverPluginModuleRewrite.ts](/static/images/vite/server-plugin-module-rewrite.png)
...
![rewrite-imports-main-structure](/static/images/vite/rewrite-imports-main-structure.png)
...
![rewrite-imports-try-main-structure](/static/images/vite/rewrite-imports-try-main-structure.png)
...
![rewrite-imports-l-156](/static/images/vite/rewrite-imports-l-156.png)
...
![importee-importer-update-code](/static/images/vite/importee-importer-update.png)
...
![literal-id-regular-expression](/static/images/vite/literal-id-regular-expression.png)
...
![module-rewrite-replace-import](/static/images/vite/module-rewrite-replace-import.png)
...
![module-rewrite-replace-hmr](/static/images/vite/module-rewrite-replace-hmr.png)
...
![module-rewrite-resolve-import-id](/static/images/vite/module-rewrite-resolve-import-id.png)
...
![module-rewrite-append-import](/static/images/vite/module-rewrite-append-import.png)
