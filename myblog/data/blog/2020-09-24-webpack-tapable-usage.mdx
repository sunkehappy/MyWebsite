...
tags: [WebPack, 源代码]
summary: 最近打算看一下WebPack的源代码，遇到的第一个我觉得需要详细看下的不太复杂的点(相比于整个WebPack的代码)就是[Tapable](https://github.com/webpack/tapable)。因为稍微看下WebPack的代码的话就会发现到处都是hooks，这些hooks就是用的这个Tapable。
---
