...
summary: 粗略的看了前两章，在这里记录一下我感兴趣的知识
---
...
![Unix操作系统架构](/static/images/architecture-of-Unix-operating-system.png)
...
![C库函数和系统调用](/static/images/C-functions-and-system-calls.png)
