...
tags: [vite, 源代码]
summary: 超快的HMR也是Vite的卖点之一，HMR的功能是通过[客户端](/posts/2021-03-17-vite-1.0-HMR-client)和这个服务端的插件来共同完成的。
---
...
![hmr-plugin-main-structure](/static/images/vite/hmr-plugin-main-structure.png)
...
![hmr-websocket-connect-switch-request](/static/images/vite/hmr-websocket-connect-switch-request.png)

对应的HTTP响应如下图：
![hmr-websocket-connect-switch-response](/static/images/vite/hmr-websocket-connect-switch-response.png)
...
![hmr-plugin-handleJSReload-main-structure](/static/images/vite/hmr-plugin-handleJSReload-main-structure.png)
